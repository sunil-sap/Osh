...
/**
 * Provides necessary meta information about the oshservices hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class OshservicesHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(OshservicesHMCExtension.class.getName());
