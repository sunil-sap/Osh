...
import com.hybris.osh.constants.OshservicesConstants;



/**
 * This is the extension manager of the Oshservices extension.
 */
public class OshservicesManager extends GeneratedOshservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OshservicesManager.class.getName());
	 ...
	 */
	public static OshservicesManager getInstance()
	{
		return (OshservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				OshservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OshservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OshservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OshservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OshservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
