...
import com.hybris.osh.constants.OshcybersourceConstants;



/**
 * This is the extension manager of the Oshcybersource extension.
 */
public class OshcybersourceManager extends GeneratedOshcybersourceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OshcybersourceManager.class.getName());
	 ...
	 */
	public static OshcybersourceManager getInstance()
	{
		return (OshcybersourceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				OshcybersourceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OshcybersourceManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OshcybersourceManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OshcybersourceManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OshcybersourceManager called, current tenant: " + getTenant().getTenantID());
		}
	}
