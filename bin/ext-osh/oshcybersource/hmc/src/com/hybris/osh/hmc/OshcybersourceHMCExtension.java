...
/**
 * Provides necessary meta information about the oshcybersource hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class OshcybersourceHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(OshcybersourceHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.hybris.osh.hmc.locales";
