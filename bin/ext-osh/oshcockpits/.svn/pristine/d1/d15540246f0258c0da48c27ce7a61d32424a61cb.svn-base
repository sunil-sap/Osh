...
import com.hybris.osh.cockpits.cmscockpit.components.contentbrowser.DefaultCmsPageContentBrowser;
import com.hybris.osh.cockpits.cmscockpit.components.contentbrowser.DefaultCmsPageMainAreaPreviewComponentFactory;
...
public class DefaultCmsPageBrowserModel extends CmsPageBrowserModel
{
	...
	public List<MainAreaComponentFactory> getAvailableViewModes()
	{
		if (viewModes == null)
		{
			...
			viewModes.add(new CmsPageMainAreaEditComponentFactory());
			viewModes.add(new DefaultCmsPageMainAreaPreviewComponentFactory(getCurrentPageObject()));
			viewModes.add(new CmsPageMainAreaPersonalizeComponentFactory());
		}
		return viewModes;
	}
	...
	{
		final DefaultCmsPageBrowserModel browserModel = new DefaultCmsPageBrowserModel();
