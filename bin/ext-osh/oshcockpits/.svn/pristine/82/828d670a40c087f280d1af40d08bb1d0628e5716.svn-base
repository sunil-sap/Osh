...
public class DefaultLiveEditBrowserArea extends LiveEditBrowserArea
{
	...
	public void initialize(final Map<String, Object> params)
	{
		if (!this.initialized)
		{
			...
			final DefaultLiveEditBrowserModel browserModel = new DefaultLiveEditBrowserModel();
	...
	@Override
	public boolean addVisibleBrowser(final int index, final BrowserModel b)
	{
		// this area does not support tabbing so we need to make sure now "unexpected" browsers are added.
		if (b instanceof DefaultLiveEditBrowserModel)
		{
			return super.addVisibleBrowser(index, b);
		}
		else
		{
			LOG.warn("Not showing browser " + b + ". Reason: Only " + DefaultLiveEditBrowserModel.class.getCanonicalName() + " allowed.");
			return false;
		}
	}
	...
	@Override
	public boolean isClosable(final BrowserModel b)
	{
		boolean closable = super.isClosable(b);
	...
	private class LiveEditBrowserAreaUISessionListener implements UISessionListener
	{
		@Override
