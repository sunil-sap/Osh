...
/**
 * Oshcscockpit popup editor area controller.
 */
public class OshcscockpitPopupEditorAreaControllerImpl extends DefaultEditorAreaController implements PopupEditorAreaController
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(OshcscockpitPopupEditorAreaControllerImpl.class);
