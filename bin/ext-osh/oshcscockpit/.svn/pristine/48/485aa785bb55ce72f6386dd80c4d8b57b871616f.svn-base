...
/**
 * This is the extension manager of the oshcscockpit extension.
 */
public class OshcscockpitManager extends GeneratedOshcscockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(OshcscockpitManager.class.getName());
	 ...
	 */
	public static final OshcscockpitManager getInstance()
	{
		return (OshcscockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				OshcscockpitConstants.EXTENSIONNAME);
	}
