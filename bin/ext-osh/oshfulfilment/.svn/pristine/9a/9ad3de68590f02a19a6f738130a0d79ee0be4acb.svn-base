...
import com.hybris.osh.actions.SendPaymentFailedNotification;
...
{
	@InjectMocks
	private final SendPaymentFailedNotification sendPaymentFailedNotification = new SendPaymentFailedNotification();
	...
	/**
	 * Test method for {@link SendPaymentFailedNotification#executeAction(OrderProcessModel)}.
	 */
	@Test
