...
import com.hybris.osh.actions.CheckAuthorizeOrderPayment;
...
public class CheckAuthorizeOrderPaymentTest
{
	...
	@InjectMocks
	private final CheckAuthorizeOrderPayment checkAuthorizeOrderPayment = new CheckAuthorizeOrderPayment();
