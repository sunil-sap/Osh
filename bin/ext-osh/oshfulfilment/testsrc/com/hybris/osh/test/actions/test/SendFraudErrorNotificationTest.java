...
import com.hybris.osh.actions.SendFraudErrorNotification;
...
{
	@InjectMocks
	private final SendFraudErrorNotification sendFraudErrorNotification = new SendFraudErrorNotification();
	...
	/**
	 * Test method for {@link SendFraudErrorNotification#executeAction(OrderProcessModel)}.
	 */
	@Test
