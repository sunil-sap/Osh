...
import com.hybris.osh.impl.DefaultCheckOrderService;
...
{
	DefaultCheckOrderService defaultCheckOrderService = new DefaultCheckOrderService();
	...
	{
		Assertions.assertThat(defaultCheckOrderService.isValid(order)).isTrue();
	}
	...
	public void testNotCalculated()
	{
		...
		Assertions.assertThat(defaultCheckOrderService.isValid(order)).isFalse();
	}
	...
	@Test
	public void testNoDeliveryAddress()
	{
