 ...
 *  
 */
package com.hybris.osh.test.setup;
...
import com.hybris.osh.test.constants.OshTestConstants;
import com.hybris.osh.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = OshTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public List<SystemSetupParameter> getInitializationOptions()
	{
		...
		//below is deliberately changed to false to avoid test data creation which was failing the initialization
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/oshtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/oshtest/import/reviews.impex");
