...
/**
 * CustomEntityDataUpsertReturn.java
 *
 ...
 */
            ...
            /**
            *  CustomEntityDataUpsertReturn bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = CustomEntityDataUpsertReturn
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for EntityDataRows
                        */

                        
                                    protected com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ArrayOfCustomEntityDataUpsertRow localEntityDataRows ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localEntityDataRowsTracker = false ;

                           public boolean isEntityDataRowsSpecified(){
                               return localEntityDataRowsTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.loyaltylab.www.loyaltyapi.ArrayOfCustomEntityDataUpsertRow
                           */
                           public  com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ArrayOfCustomEntityDataUpsertRow getEntityDataRows(){
                               return localEntityDataRows;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param EntityDataRows
                               */
                               public void setEntityDataRows(com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ArrayOfCustomEntityDataUpsertRow param){
                            localEntityDataRowsTracker = param != null;
                                   
                                            this.localEntityDataRows=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CustomEntityDataUpsertReturn",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CustomEntityDataUpsertReturn",
                           xmlWriter);
                   }
                              ...
                              if (localReferenceTagTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localEntityDataRowsTracker){
                                            if (localEntityDataRows==null){
                                                 throw new org.apache.axis2.databinding.ADBException("EntityDataRows cannot be null!!");
                                            }
                                           localEntityDataRows.serialize(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","EntityDataRows"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/",
                                    ...
                                    elementList.add(localEntityDataRows);
                                }
    ...
    public static class Factory{
        ...
        */
        public static CustomEntityDataUpsertReturn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CustomEntityDataUpsertReturn object =
                new CustomEntityDataUpsertReturn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CustomEntityDataUpsertReturn".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CustomEntityDataUpsertReturn)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","EntityDataRows").equals(reader.getName())){
                                
                                                object.setEntityDataRows(com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ArrayOfCustomEntityDataUpsertRow.Factory.parse(reader));
