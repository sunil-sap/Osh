...
import com.hybris.osh.storefront.history.BrowseHistory;
import com.hybris.osh.storefront.history.BrowseHistoryEntry;
...
/**
 * Filter that initializes the session for the oshstorefront. This is a spring configured filter that is
