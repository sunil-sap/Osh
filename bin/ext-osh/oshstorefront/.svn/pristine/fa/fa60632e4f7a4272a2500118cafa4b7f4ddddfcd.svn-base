 ...
 */
            ...
            /**
            *  UpdateCustomAttribute bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected java.lang.String localCAValue ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localCAValueTracker = false ;

                           public boolean isCAValueSpecified(){
                               return localCAValueTracker;
                           }
                           ...
                           */
                           public  java.lang.String getCAValue(){
                            ...
                            /**
                               ...
                               * @param param CAValue
                               */
                               public void setCAValue(java.lang.String param){
                            localCAValueTracker = param != null;
                                   
                                            this.localCAValue=param;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UpdateCustomAttribute",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UpdateCustomAttribute",
                ...
                if (localReferenceTypeTracker){
                              ...
                              if (localReferenceTagTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localCAValueTracker){
                                    namespace = "http://www.loyaltylab.com/loyaltyapi/";
                                    writeStartElement(null, namespace, "CAValue", xmlWriter);
                             

                                          if (localCAValue==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("CAValue cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localCAValue);
                 ...
                 if (localReferenceTypeTracker){
                             ...
                             if (localReferenceTagTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/",
                                        ...
                                        if (localCAValue != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCAValue));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("CAValue cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static UpdateCustomAttribute parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UpdateCustomAttribute object =
                new UpdateCustomAttribute();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UpdateCustomAttribute".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UpdateCustomAttribute)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","CAValue").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"CAValue" +"  cannot be null");
                                    }
