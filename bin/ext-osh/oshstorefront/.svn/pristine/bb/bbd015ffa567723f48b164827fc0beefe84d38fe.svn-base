 ...
 *  
 */
package com.hybris.osh.storefront.security.cookie;
...
/**
 * Stripped out {@link org.apache.tomcat.util.http.ServerCookie} for use of
 * {@link #appendCookieValue(StringBuffer, int, String, String, String, String, String, int, boolean, boolean)}
 */
