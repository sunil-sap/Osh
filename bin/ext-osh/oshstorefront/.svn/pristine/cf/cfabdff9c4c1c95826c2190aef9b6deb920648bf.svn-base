				...
				<form:form method="post" commandName="paymentDetailsForm" class="create_update_payment_form">
					...
					<div class="payment_details_right_col">
						...
						<dl id="newBillingAddressFields">
							...
							<formElement:formSelectBox idKey="address.title" labelKey="address.title" path="billingAddress.titleCode" maxlength="15" mandatory="true" skipBlank="false" skipBlankMessageKey="address.title.pleaseSelect" items="${titles}" tabindex="10"/>
							<formElement:formInputBox idKey="address.firstName" labelKey="address.firstName" path="billingAddress.firstName" inputCSS="text" maxlength="15" mandatory="true" tabindex="11"/>
							<formElement:formInputBox idKey="address.surname" labelKey="address.surname" path="billingAddress.lastName" inputCSS="text" maxlength="15" mandatory="true" tabindex="12"/>
							<formElement:formInputBox idKey="address.line1" labelKey="address.line1" path="billingAddress.line1" inputCSS="text"  maxlength="40" mandatory="true" tabindex="13"/>
							<formElement:formInputBox idKey="address.line2" labelKey="address.line2" path="billingAddress.line2" inputCSS="text" maxlength="40" mandatory="false" tabindex="14"/>
					...
					<div class="save_payment_details">
						...
						<span style="display: block; clear: both;">
							<ycommerce:testId code="editPaymentMethod_savePaymentMethod_button">
								<button class="form" tabindex="19" id="lastInTheForm">
