 ...
 */
            ...
            /**
            *  AdjustShopperPoints bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AdjustShopperPoints
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AdjustShopperPoints",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AdjustShopperPoints",
    ...
    public static class Factory{
        ...
        */
        public static AdjustShopperPoints parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AdjustShopperPoints object =
                new AdjustShopperPoints();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AdjustShopperPoints".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AdjustShopperPoints)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
