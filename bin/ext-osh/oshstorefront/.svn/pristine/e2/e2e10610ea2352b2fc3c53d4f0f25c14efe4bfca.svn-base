...
import com.hybris.osh.storefront.forms.ForgottenPwdForm;
import com.hybris.osh.storefront.forms.UpdatePwdForm;
...
public class PasswordResetPageController extends AbstractPageController
{
	...
	//private static final String FORGOT_PASSWORDCONFIRMATION_CMS_PAGE = "forgotPwdConfirmationPage";
			...
			final RedirectAttributes redirectModel, final HttpServletRequest request) throws CMSItemNotFoundException
	{
		...
		else
		{
			try
			{
				...
				redirectModel.addAttribute("email", form.getEmail());
				final HttpSession session = request.getSession();
				session.setAttribute("passwordRequest", Boolean.TRUE);
