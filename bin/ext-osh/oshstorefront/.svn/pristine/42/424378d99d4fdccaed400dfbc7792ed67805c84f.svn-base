 ...
 */
            ...
            /**
            *  RedeemOffer bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RedeemOffer
    ...
    public static class Factory{
        ...
        */
        public static RedeemOffer parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RedeemOffer object =
                new RedeemOffer();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RedeemOffer".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RedeemOffer)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
