 ...
 */
            ...
            /**
            *  ShopperSignIn bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ShopperSignIn
    ...
    public static class Factory{
        ...
        */
        public static ShopperSignIn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ShopperSignIn object =
                new ShopperSignIn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ShopperSignIn".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ShopperSignIn)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","password").equals(reader.getName())){
