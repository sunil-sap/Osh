...
/**
 * GetShopperRegisteredCards.java
 *
 ...
 */
            ...
            /**
            *  GetShopperRegisteredCards bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetShopperRegisteredCards
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetShopperRegisteredCards",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetShopperRegisteredCards",
    ...
    public static class Factory{
        ...
        */
        public static GetShopperRegisteredCards parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetShopperRegisteredCards object =
                new GetShopperRegisteredCards();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetShopperRegisteredCards".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetShopperRegisteredCards)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
