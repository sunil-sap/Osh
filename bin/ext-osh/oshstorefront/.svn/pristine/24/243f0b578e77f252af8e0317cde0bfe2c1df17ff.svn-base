 ...
 */
            ...
            /**
            *  UpdateCustomEntity bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UpdateCustomEntity
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ArrayOfAPICustomEntity1 localEntities ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.loyaltylab.www.loyaltyapi.ArrayOfAPICustomEntity1
                           */
                           public  com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ArrayOfAPICustomEntity1 getEntities(){
                            ...
                            /**
                               ...
                               */
                               public void setEntities(com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ArrayOfAPICustomEntity1 param){
                            localEntitiesTracker = param != null;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UpdateCustomEntity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UpdateCustomEntity",
                ...
                if (localReferenceTagTracker){
                              ...
                              if (localEntitiesTracker){
                                           ...
                                           localEntities.serialize(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","entities"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static UpdateCustomEntity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UpdateCustomEntity object =
                new UpdateCustomEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UpdateCustomEntity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UpdateCustomEntity)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","entities").equals(reader.getName())){
                                
                                                object.setEntities(com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ArrayOfAPICustomEntity1.Factory.parse(reader));
