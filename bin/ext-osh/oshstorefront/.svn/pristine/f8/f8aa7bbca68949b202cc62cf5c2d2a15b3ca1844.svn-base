 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static Tender parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Tender object =
                new Tender();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Tender".equals(type)){
                                ...
                                return (Tender)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
