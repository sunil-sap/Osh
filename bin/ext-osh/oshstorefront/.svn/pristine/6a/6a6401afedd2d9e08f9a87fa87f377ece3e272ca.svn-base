 ...
 */
            ...
            /**
            *  AddShopperToProgram bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddShopperToProgram
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AddShopperToProgram",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AddShopperToProgram",
    ...
    public static class Factory{
        ...
        */
        public static AddShopperToProgram parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddShopperToProgram object =
                new AddShopperToProgram();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AddShopperToProgram".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddShopperToProgram)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
