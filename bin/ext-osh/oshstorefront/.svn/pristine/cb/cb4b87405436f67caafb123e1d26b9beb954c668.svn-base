 ...
 */
            ...
            /**
            *  UpdateRewardProduct bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UpdateRewardProduct
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UpdateRewardProduct",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UpdateRewardProduct",
    ...
    public static class Factory{
        ...
        */
        public static UpdateRewardProduct parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UpdateRewardProduct object =
                new UpdateRewardProduct();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UpdateRewardProduct".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UpdateRewardProduct)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
