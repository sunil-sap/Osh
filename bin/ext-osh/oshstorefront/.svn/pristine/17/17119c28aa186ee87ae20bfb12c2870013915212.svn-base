...
/**
 * RedeemShopperRewardCerificate.java
 *
 ...
 */
            ...
            /**
            *  RedeemShopperRewardCerificate bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for RewardNumber
                        */

                        
                                    protected java.lang.String localRewardNumber ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRewardNumberTracker = false ;

                           public boolean isRewardNumberSpecified(){
                               return localRewardNumberTracker;
                           }
                           ...
                           */
                           public  java.lang.String getRewardNumber(){
                               return localRewardNumber;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param RewardNumber
                               */
                               public void setRewardNumber(java.lang.String param){
                            localRewardNumberTracker = param != null;
                                   
                                            this.localRewardNumber=param;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RedeemShopperRewardCerificate",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RedeemShopperRewardCerificate",
                ...
                if (localShopperIdentifierTracker){
                                           ...
                                           localShopperIdentifier.serialize(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","shopperIdentifier"),
                                               xmlWriter);
                                        } if (localRewardNumberTracker){
                                    namespace = "http://www.loyaltylab.com/loyaltyapi/";
                                    writeStartElement(null, namespace, "rewardNumber", xmlWriter);
                             

                                          if (localRewardNumber==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("rewardNumber cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localRewardNumber);
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/",
                                    ...
                                    elementList.add(localShopperIdentifier);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/",
                                        ...
                                        if (localRewardNumber != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRewardNumber));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("rewardNumber cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static RedeemShopperRewardCerificate parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RedeemShopperRewardCerificate object =
                new RedeemShopperRewardCerificate();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RedeemShopperRewardCerificate".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RedeemShopperRewardCerificate)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","rewardNumber").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"rewardNumber" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setRewardNumber(
