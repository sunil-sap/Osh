 ...
 */
            ...
            /**
            *  UnEnrollShopper bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UnEnrollShopper
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UnEnrollShopper",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UnEnrollShopper",
    ...
    public static class Factory{
        ...
        */
        public static UnEnrollShopper parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UnEnrollShopper object =
                new UnEnrollShopper();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UnEnrollShopper".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UnEnrollShopper)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
