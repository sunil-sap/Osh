...
/**
 * GetShopperRedemptionsByDate.java
 *
 ...
 */
            ...
            /**
            *  GetShopperRedemptionsByDate bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetShopperRedemptionsByDate
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetShopperRedemptionsByDate",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetShopperRedemptionsByDate",
    ...
    public static class Factory{
        ...
        */
        public static GetShopperRedemptionsByDate parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetShopperRedemptionsByDate object =
                new GetShopperRedemptionsByDate();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetShopperRedemptionsByDate".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetShopperRedemptionsByDate)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
