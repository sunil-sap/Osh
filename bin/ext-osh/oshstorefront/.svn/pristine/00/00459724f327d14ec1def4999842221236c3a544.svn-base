...
/**
 * GetTotalPointsEarnedByEmailAddress.java
 *
 ...
 */
            ...
            /**
            *  GetTotalPointsEarnedByEmailAddress bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTotalPointsEarnedByEmailAddress
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetTotalPointsEarnedByEmailAddress",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetTotalPointsEarnedByEmailAddress",
    ...
    public static class Factory{
        ...
        */
        public static GetTotalPointsEarnedByEmailAddress parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTotalPointsEarnedByEmailAddress object =
                new GetTotalPointsEarnedByEmailAddress();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetTotalPointsEarnedByEmailAddress".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTotalPointsEarnedByEmailAddress)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
