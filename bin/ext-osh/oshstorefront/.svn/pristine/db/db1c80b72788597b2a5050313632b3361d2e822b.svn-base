...
/**
 * AdjustShopperPointsWithExpirationDate.java
 *
 ...
 */
            ...
            /**
            *  AdjustShopperPointsWithExpirationDate bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AdjustShopperPointsWithExpirationDate
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AdjustShopperPointsWithExpirationDate",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AdjustShopperPointsWithExpirationDate",
    ...
    public static class Factory{
        ...
        */
        public static AdjustShopperPointsWithExpirationDate parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AdjustShopperPointsWithExpirationDate object =
                new AdjustShopperPointsWithExpirationDate();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AdjustShopperPointsWithExpirationDate".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AdjustShopperPointsWithExpirationDate)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
