...
/**
 * GetCustomQuestionsForShopper.java
 *
 ...
 */
            ...
            /**
            *  GetCustomQuestionsForShopper bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetCustomQuestionsForShopper
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetCustomQuestionsForShopper",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetCustomQuestionsForShopper",
    ...
    public static class Factory{
        ...
        */
        public static GetCustomQuestionsForShopper parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCustomQuestionsForShopper object =
                new GetCustomQuestionsForShopper();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetCustomQuestionsForShopper".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCustomQuestionsForShopper)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
