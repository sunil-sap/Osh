...
/**
 * GetReferenceObjectFromUniqueCustomEntity.java
 *
 ...
 */
            ...
            /**
            *  GetReferenceObjectFromUniqueCustomEntity bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetReferenceObjectFromUniqueCustomEntity
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetReferenceObjectFromUniqueCustomEntity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetReferenceObjectFromUniqueCustomEntity",
    ...
    public static class Factory{
        ...
        */
        public static GetReferenceObjectFromUniqueCustomEntity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetReferenceObjectFromUniqueCustomEntity object =
                new GetReferenceObjectFromUniqueCustomEntity();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetReferenceObjectFromUniqueCustomEntity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetReferenceObjectFromUniqueCustomEntity)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
