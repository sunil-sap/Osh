 ...
 */
            ...
            /**
            *  GetShoppersByPhoneNumber bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetShoppersByPhoneNumber
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetShoppersByPhoneNumber",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetShoppersByPhoneNumber",
    ...
    public static class Factory{
        ...
        */
        public static GetShoppersByPhoneNumber parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetShoppersByPhoneNumber object =
                new GetShoppersByPhoneNumber();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetShoppersByPhoneNumber".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetShoppersByPhoneNumber)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","phoneNumber").equals(reader.getName())){
