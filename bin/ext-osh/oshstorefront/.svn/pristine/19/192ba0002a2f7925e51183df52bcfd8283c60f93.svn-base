 ...
 */
            ...
            /**
            *  GetShopperOffersExtended bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetShopperOffersExtended
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetShopperOffersExtended",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetShopperOffersExtended",
    ...
    public static class Factory{
        ...
        */
        public static GetShopperOffersExtended parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetShopperOffersExtended object =
                new GetShopperOffersExtended();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetShopperOffersExtended".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetShopperOffersExtended)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
