 ...
 *  
 */
package com.hybris.osh.storefront.interceptors.beforecontroller;
	...
	public boolean beforeController(final HttpServletRequest request, final HttpServletResponse response) throws IOException
	{
		...
		if (authentication != null)
		{
			...
			if (principal instanceof String)
			{
				...
				{
					LOG.error("User miss-match springSecurityUserId [" + springSecurityUserId + "] hybris session user [" + hybrisUserId + "]. Invalidating session.");
