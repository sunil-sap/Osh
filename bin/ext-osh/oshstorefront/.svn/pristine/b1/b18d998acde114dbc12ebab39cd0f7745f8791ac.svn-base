...
/**
 * GetShopperRedemptionsByShopperId.java
 *
 ...
 */
            ...
            /**
            *  GetShopperRedemptionsByShopperId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetShopperRedemptionsByShopperId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetShopperRedemptionsByShopperId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetShopperRedemptionsByShopperId",
    ...
    public static class Factory{
        ...
        */
        public static GetShopperRedemptionsByShopperId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetShopperRedemptionsByShopperId object =
                new GetShopperRedemptionsByShopperId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetShopperRedemptionsByShopperId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetShopperRedemptionsByShopperId)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
