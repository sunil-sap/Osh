 ...
 */
            ...
            /**
            *  RedemptionOrderItem bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RedemptionOrderItem
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RedemptionOrderItem",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RedemptionOrderItem",
    ...
    public static class Factory{
        ...
        */
        public static RedemptionOrderItem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RedemptionOrderItem object =
                new RedemptionOrderItem();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RedemptionOrderItem".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RedemptionOrderItem)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
