 ...
 */
            ...
            /**
            *  CustomAttributeParameter bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for AttributesToSet
                        */

                        
                                    protected com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ArrayOfAttributeToSet localAttributesToSet ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAttributesToSetTracker = false ;

                           public boolean isAttributesToSetSpecified(){
                               return localAttributesToSetTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.loyaltylab.www.loyaltyapi.ArrayOfAttributeToSet
                           */
                           public  com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ArrayOfAttributeToSet getAttributesToSet(){
                               return localAttributesToSet;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param AttributesToSet
                               */
                               public void setAttributesToSet(com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ArrayOfAttributeToSet param){
                            localAttributesToSetTracker = param != null;
                                   
                                            this.localAttributesToSet=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CustomAttributeParameter",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                              ...
                              if (localReferenceTypeTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localAttributesToSetTracker){
                                            if (localAttributesToSet==null){
                                                 throw new org.apache.axis2.databinding.ADBException("AttributesToSet cannot be null!!");
                                            }
                                           localAttributesToSet.serialize(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","AttributesToSet"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/",
                                    ...
                                    elementList.add(localAttributesToSet);
                                }
    ...
    public static class Factory{
        ...
        */
        public static CustomAttributeParameter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CustomAttributeParameter object =
                new CustomAttributeParameter();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CustomAttributeParameter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CustomAttributeParameter)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","AttributesToSet").equals(reader.getName())){
                                
                                                object.setAttributesToSet(com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ArrayOfAttributeToSet.Factory.parse(reader));
