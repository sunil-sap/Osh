 ...
 */
            ...
            /**
            *  GetShopperPrograms bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetShopperPrograms
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetShopperPrograms",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetShopperPrograms",
    ...
    public static class Factory{
        ...
        */
        public static GetShopperPrograms parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetShopperPrograms object =
                new GetShopperPrograms();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetShopperPrograms".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetShopperPrograms)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
