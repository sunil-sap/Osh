...
/**
 * UpdateCustomQuestionForShopper.java
 *
 ...
 */
            ...
            /**
            *  UpdateCustomQuestionForShopper bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ShopperQuestionAnswerSet localAnswerSet ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAnswerSetTracker = false ;

                           public boolean isAnswerSetSpecified(){
                               return localAnswerSetTracker;
                           }
                           ...
                           */
                           public  com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ShopperQuestionAnswerSet getAnswerSet(){
                               return localAnswerSet;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param AnswerSet
                               */
                               public void setAnswerSet(com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ShopperQuestionAnswerSet param){
                            localAnswerSetTracker = param != null;
                                   
                                            this.localAnswerSet=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UpdateCustomQuestionForShopper",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UpdateCustomQuestionForShopper",
                           xmlWriter);
                              ...
                              if (localAnswerSetTracker){
                                            if (localAnswerSet==null){
                                                 throw new org.apache.axis2.databinding.ADBException("answerSet cannot be null!!");
                                            }
                                           localAnswerSet.serialize(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","answerSet"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/",
                                    ...
                                    elementList.add(localAnswerSet);
                                } if (localChannelTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/",
                                                                      "channel"));
    ...
    public static class Factory{
        ...
        */
        public static UpdateCustomQuestionForShopper parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UpdateCustomQuestionForShopper object =
                new UpdateCustomQuestionForShopper();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UpdateCustomQuestionForShopper".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UpdateCustomQuestionForShopper)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","answerSet").equals(reader.getName())){
                                
                                                object.setAnswerSet(com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ShopperQuestionAnswerSet.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","channel").equals(reader.getName())){
