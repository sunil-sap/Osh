...
/**
 * GetPlcAvailablePointsByDateByPointGroup.java
 *
 ...
 */
            ...
            /**
            *  GetPlcAvailablePointsByDateByPointGroup bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPlcAvailablePointsByDateByPointGroup
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetPlcAvailablePointsByDateByPointGroup",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetPlcAvailablePointsByDateByPointGroup",
    ...
    public static class Factory{
        ...
        */
        public static GetPlcAvailablePointsByDateByPointGroup parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPlcAvailablePointsByDateByPointGroup object =
                new GetPlcAvailablePointsByDateByPointGroup();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetPlcAvailablePointsByDateByPointGroup".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPlcAvailablePointsByDateByPointGroup)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
