                ...
                if (localStringTracker){
                             if (localString!=null) {
                                   ...
                                   for (int i = 0;i < localString.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://www.loyaltylab.com/loyaltyapi/", "string", xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ArrayOfString".equals(type)){
                                ...
                                return (ArrayOfString)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","string").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","string").equals(reader.getName())){
