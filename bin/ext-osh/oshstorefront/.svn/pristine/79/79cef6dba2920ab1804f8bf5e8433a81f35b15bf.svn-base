...
/**
 * GetRewardProductByUniqueSKU.java
 *
 ...
 */
            ...
            /**
            *  GetRewardProductByUniqueSKU bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetRewardProductByUniqueSKU
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetRewardProductByUniqueSKU",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetRewardProductByUniqueSKU",
    ...
    public static class Factory{
        ...
        */
        public static GetRewardProductByUniqueSKU parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetRewardProductByUniqueSKU object =
                new GetRewardProductByUniqueSKU();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetRewardProductByUniqueSKU".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetRewardProductByUniqueSKU)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
