								...
								<form>
									<div class="ui-grid-a" data-theme="b" style="width: 100%">
										<div class="ui-block-a" style="width: 60%">
											...
											<a href="#" id="cvv2Description" data-cvv2description="<spring:message code='checkout.summary.paymentMethod.securityCode.whatIsThis.description'/>">
												<br />
				...
				<div class="ui-block-b" style="width: 15%">
					<ycommerce:testId code="checkout_changePayment_element">
						<c:if test="${paymentInfoOk}">
							...
							<a href="${choosePaymentMethodUrl} class=" edit_complete change_payment_method_button" data-theme="c">
