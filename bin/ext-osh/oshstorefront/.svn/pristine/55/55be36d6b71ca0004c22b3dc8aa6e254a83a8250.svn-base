...
/**
 * GetShopperPointBalanceByBalanceType.java
 *
 ...
 */
            ...
            /**
            *  GetShopperPointBalanceByBalanceType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetShopperPointBalanceByBalanceType
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected java.lang.String localBalanceType ;
                           ...
                           */
                           public  java.lang.String getBalanceType(){
                            ...
                            /**
                               ...
                               */
                               public void setBalanceType(java.lang.String param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetShopperPointBalanceByBalanceType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetShopperPointBalanceByBalanceType",
                           xmlWriter);
                              ...
                              if (localBalanceTypeTracker){
                                    namespace = "http://www.loyaltylab.com/loyaltyapi/";
                                    writeStartElement(null, namespace, "balanceType", xmlWriter);
                                          ...
                                          if (localBalanceType==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localBalanceType);
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                             ...
                             if (localBalanceTypeTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/",
                                        ...
                                        if (localBalanceType != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localBalanceType));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("balanceType cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static GetShopperPointBalanceByBalanceType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetShopperPointBalanceByBalanceType object =
                new GetShopperPointBalanceByBalanceType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetShopperPointBalanceByBalanceType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetShopperPointBalanceByBalanceType)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","balanceType").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"balanceType" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setBalanceType(
