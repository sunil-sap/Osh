...
/**
 * GetShopperRedemptionsOrderItemsByDate.java
 *
 ...
 */
            ...
            /**
            *  GetShopperRedemptionsOrderItemsByDate bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetShopperRedemptionsOrderItemsByDate
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetShopperRedemptionsOrderItemsByDate",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetShopperRedemptionsOrderItemsByDate",
    ...
    public static class Factory{
        ...
        */
        public static GetShopperRedemptionsOrderItemsByDate parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetShopperRedemptionsOrderItemsByDate object =
                new GetShopperRedemptionsOrderItemsByDate();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetShopperRedemptionsOrderItemsByDate".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetShopperRedemptionsOrderItemsByDate)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
