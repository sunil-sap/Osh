 ...
 */
            ...
            /**
            *  GetProfilesByShopperId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetProfilesByShopperId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetProfilesByShopperId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetProfilesByShopperId",
    ...
    public static class Factory{
        ...
        */
        public static GetProfilesByShopperId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetProfilesByShopperId object =
                new GetProfilesByShopperId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetProfilesByShopperId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetProfilesByShopperId)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
