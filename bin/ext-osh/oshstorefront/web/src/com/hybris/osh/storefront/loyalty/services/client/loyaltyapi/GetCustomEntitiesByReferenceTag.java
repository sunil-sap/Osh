...
/**
 * GetCustomEntitiesByReferenceTag.java
 *
 ...
 */
            ...
            /**
            *  GetCustomEntitiesByReferenceTag bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetCustomEntitiesByReferenceTag
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetCustomEntitiesByReferenceTag",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetCustomEntitiesByReferenceTag",
    ...
    public static class Factory{
        ...
        */
        public static GetCustomEntitiesByReferenceTag parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCustomEntitiesByReferenceTag object =
                new GetCustomEntitiesByReferenceTag();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetCustomEntitiesByReferenceTag".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCustomEntitiesByReferenceTag)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
