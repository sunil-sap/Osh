 ...
 */
            ...
            /**
            *  UpdateShopperOfferStatus bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UpdateShopperOfferStatus
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.OfferStatus localStatus ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.OfferStatus getStatus(){
                               return localStatus;
                           }
                            ...
                            /**
                               ...
                               * @param param Status
                               */
                               public void setStatus(com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.OfferStatus param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UpdateShopperOfferStatus",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UpdateShopperOfferStatus",
                           xmlWriter);
                              ...
                              if (localStatusTracker){
                                           ...
                                           localStatus.serialize(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","status"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static UpdateShopperOfferStatus parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UpdateShopperOfferStatus object =
                new UpdateShopperOfferStatus();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UpdateShopperOfferStatus".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UpdateShopperOfferStatus)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","status").equals(reader.getName())){
                                                ...
                                                object.setStatus(com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.OfferStatus.Factory.parse(reader));
