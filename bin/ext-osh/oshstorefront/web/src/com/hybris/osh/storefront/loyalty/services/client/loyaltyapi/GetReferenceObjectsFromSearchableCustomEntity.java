...
/**
 * GetReferenceObjectsFromSearchableCustomEntity.java
 *
 ...
 */
            ...
            /**
            *  GetReferenceObjectsFromSearchableCustomEntity bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetReferenceObjectsFromSearchableCustomEntity
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.APICustomEntity localEntity ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.APICustomEntity getEntity(){
                               return localEntity;
                           }
                            ...
                            /**
                               ...
                               * @param param Entity
                               */
                               public void setEntity(com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.APICustomEntity param){
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetReferenceObjectsFromSearchableCustomEntity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetReferenceObjectsFromSearchableCustomEntity",
                ...
                if (localReferenceTagTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localEntity.serialize(new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","entity"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static GetReferenceObjectsFromSearchableCustomEntity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetReferenceObjectsFromSearchableCustomEntity object =
                new GetReferenceObjectsFromSearchableCustomEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetReferenceObjectsFromSearchableCustomEntity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetReferenceObjectsFromSearchableCustomEntity)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.loyaltylab.com/loyaltyapi/","entity").equals(reader.getName())){
                                
                                                object.setEntity(com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.APICustomEntity.Factory.parse(reader));
