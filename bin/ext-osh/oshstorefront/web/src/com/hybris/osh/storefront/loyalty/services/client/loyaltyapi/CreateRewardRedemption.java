 ...
 */
            ...
            /**
            *  CreateRewardRedemption bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CreateRewardRedemption
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CreateRewardRedemption",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CreateRewardRedemption",
    ...
    public static class Factory{
        ...
        */
        public static CreateRewardRedemption parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreateRewardRedemption object =
                new CreateRewardRedemption();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CreateRewardRedemption".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreateRewardRedemption)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
