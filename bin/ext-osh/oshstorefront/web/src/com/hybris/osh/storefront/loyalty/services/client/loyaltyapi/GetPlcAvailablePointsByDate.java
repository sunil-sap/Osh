...
/**
 * GetPlcAvailablePointsByDate.java
 *
 ...
 */
            ...
            /**
            *  GetPlcAvailablePointsByDate bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPlcAvailablePointsByDate
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetPlcAvailablePointsByDate",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetPlcAvailablePointsByDate",
    ...
    public static class Factory{
        ...
        */
        public static GetPlcAvailablePointsByDate parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPlcAvailablePointsByDate object =
                new GetPlcAvailablePointsByDate();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetPlcAvailablePointsByDate".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPlcAvailablePointsByDate)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
