 ...
 *  
 */
package com.hybris.osh.storefront.tags;
...
public class Functions
{
	...
	public static ImageData getPrimaryImageForProductAndFormat(final ProductData product, final String format)
	{
		if (product != null && format != null)
		{
			...
			if (images != null && !images.isEmpty())
			{
				...
				{
					if (ImageData.ImageType.PRIMARY.equals(image.getImageType()) && format.equals(image.getFormat()))
					{
						return image;
					}
				}
	...
	{
		return RequestContextUtils.getWebApplicationContext(httpRequest, httpRequest.getSession().getServletContext()).getBean(beanName, beanClass);
	}
	...
	protected static boolean doesPromotionExistForOrderEntry(final List<PromotionResultData> productPromotions, final int entryNumber)
	{
