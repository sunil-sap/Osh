 ...
 */
            ...
            /**
            *  EnrollShopper bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EnrollShopper
    ...
    public static class Factory{
        ...
        */
        public static EnrollShopper parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnrollShopper object =
                new EnrollShopper();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EnrollShopper".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EnrollShopper)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
