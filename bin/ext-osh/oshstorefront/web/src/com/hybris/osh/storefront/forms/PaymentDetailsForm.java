...
public class PaymentDetailsForm
{
	...
	private Boolean isAccountPaymentForm;
	...
	@Size(min = 15, max = 16, message = "{payment.cardNumber.invalid}")
	 ...
	 */
	@NotNull(message = "{payment.CVVNo.invalid}")
	@Size(min = 3, max = 4, message = "{payment.CVVNo.invalid}")
	...
	public Boolean getIsAccountPaymentForm()
	{
		return isAccountPaymentForm;
	}

	public void setIsAccountPaymentForm(final Boolean isAccountPaymentForm)
	{
		this.isAccountPaymentForm = isAccountPaymentForm;
	}
