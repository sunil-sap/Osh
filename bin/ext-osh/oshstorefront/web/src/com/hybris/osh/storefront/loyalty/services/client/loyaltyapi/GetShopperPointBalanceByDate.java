...
/**
 * GetShopperPointBalanceByDate.java
 *
 ...
 */
            ...
            /**
            *  GetShopperPointBalanceByDate bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetShopperPointBalanceByDate
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetShopperPointBalanceByDate",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetShopperPointBalanceByDate",
    ...
    public static class Factory{
        ...
        */
        public static GetShopperPointBalanceByDate parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetShopperPointBalanceByDate object =
                new GetShopperPointBalanceByDate();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetShopperPointBalanceByDate".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetShopperPointBalanceByDate)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
