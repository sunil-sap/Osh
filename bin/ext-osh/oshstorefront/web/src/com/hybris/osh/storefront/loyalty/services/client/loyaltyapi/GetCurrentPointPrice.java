 ...
 */
            ...
            /**
            *  GetCurrentPointPrice bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetCurrentPointPrice
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetCurrentPointPrice",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetCurrentPointPrice",
    ...
    public static class Factory{
        ...
        */
        public static GetCurrentPointPrice parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCurrentPointPrice object =
                new GetCurrentPointPrice();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetCurrentPointPrice".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCurrentPointPrice)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
