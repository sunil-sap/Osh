 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static LineItem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LineItem object =
                new LineItem();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LineItem".equals(type)){
                                ...
                                return (LineItem)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
