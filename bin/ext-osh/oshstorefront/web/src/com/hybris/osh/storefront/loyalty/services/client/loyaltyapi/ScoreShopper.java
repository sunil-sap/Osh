 ...
 */
            ...
            /**
            *  ScoreShopper bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ScoreShopper
    ...
    public static class Factory{
        ...
        */
        public static ScoreShopper parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ScoreShopper object =
                new ScoreShopper();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ScoreShopper".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ScoreShopper)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
