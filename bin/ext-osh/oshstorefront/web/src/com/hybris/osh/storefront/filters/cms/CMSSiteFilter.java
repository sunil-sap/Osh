 ...
 *  
 */
package com.hybris.osh.storefront.filters.cms;
...
public class CMSSiteFilter extends OncePerRequestFilter implements CMSFilter
{
			...
			final FilterChain filterChain) throws ServletException, IOException
	{
		...
		{
			final String redirectURL = processPreviewRequest(httpRequest);
	...
	{
		final PreviewDataModel previewDataModel = getPreviewData(getPreviewTicketId(httpRequest));
