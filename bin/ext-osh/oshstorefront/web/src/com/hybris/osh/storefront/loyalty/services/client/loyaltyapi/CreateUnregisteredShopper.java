...
/**
 * CreateUnregisteredShopper.java
 *
 ...
 */
            ...
            /**
            *  CreateUnregisteredShopper bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CreateUnregisteredShopper
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CreateUnregisteredShopper",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CreateUnregisteredShopper",
    ...
    public static class Factory{
        ...
        */
        public static CreateUnregisteredShopper parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreateUnregisteredShopper object =
                new CreateUnregisteredShopper();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CreateUnregisteredShopper".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreateUnregisteredShopper)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
