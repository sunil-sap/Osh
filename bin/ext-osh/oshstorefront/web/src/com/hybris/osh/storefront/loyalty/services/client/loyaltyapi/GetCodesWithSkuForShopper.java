...
/**
 * GetCodesWithSkuForShopper.java
 *
 ...
 */
            ...
            /**
            *  GetCodesWithSkuForShopper bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetCodesWithSkuForShopper
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetCodesWithSkuForShopper",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetCodesWithSkuForShopper",
    ...
    public static class Factory{
        ...
        */
        public static GetCodesWithSkuForShopper parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCodesWithSkuForShopper object =
                new GetCodesWithSkuForShopper();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetCodesWithSkuForShopper".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCodesWithSkuForShopper)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
