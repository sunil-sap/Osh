 ...
 */
            ...
            /**
            *  GetTransactionsByDate bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTransactionsByDate
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetTransactionsByDate",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetTransactionsByDate",
    ...
    public static class Factory{
        ...
        */
        public static GetTransactionsByDate parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTransactionsByDate object =
                new GetTransactionsByDate();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetTransactionsByDate".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTransactionsByDate)com.hybris.osh.storefront.loyalty.services.client.loyaltyapi.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
