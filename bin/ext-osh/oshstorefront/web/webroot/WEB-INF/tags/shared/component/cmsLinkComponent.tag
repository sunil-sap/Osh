...
<a href="${encodedUrl}" ${component.styleAttributes} title="${component.linkName}" ${component.target == null || component.target == 'SAMEWINDOW' ? '' : 'target="_new"'}  >${component.linkName}</a>
</c:when>
</c:choose>