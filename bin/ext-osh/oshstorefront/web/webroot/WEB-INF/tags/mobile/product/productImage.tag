...
<c:if test="${not empty galleryImages}">
	<div id="imageGallery" data-enabled='true' class="hasThumbnail" data-thumbnail="${thumbnailImage.url}">
		<c:forEach items="${galleryImages}" var="container" varStatus="varStatus">
			<div class='imageGallerySlide'
...
<c:if test="${empty galleryImages}">
	<div><theme:image code="img.missingProductImage.product" alt="Missing roduct image" title="Missing roduct image"/></div>
</c:if>
