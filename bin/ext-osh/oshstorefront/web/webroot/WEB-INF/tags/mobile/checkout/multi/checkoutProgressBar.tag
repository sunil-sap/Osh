			...
			<c:choose>
				<c:when test="${stepName eq checkoutStep.stepName}">
					<li class="checkoutStep40">
						<a href="${checkoutStep.url}" data-theme="c" data-corners="false" data-role="button" aria-disabled="true">
				...
				<c:otherwise>
					<li class="checkoutStep20">
						<a href="${checkoutStep.url}" data-theme="c" data-corners="false" data-role="button">
							<spring:theme code="mobile.checkout.${checkoutStep.stepName}" />
						</a>
					</li>
				</c:otherwise>
