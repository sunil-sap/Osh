...
<template:page pageTitle="${pageTitle}">
	<div class="accmob-navigationHolder">
		<div class="accmob-navigationContent">
			<div id="breadcrumb" class="accmobBackLink accmobBackLinkSingle">
				<a href="${productDataUrl}" class="productLink">< ${productData.name}</a>
			</div>
		</div>
	</div>
	<div class="item_container_holder">
		...
		<h3>
			<spring:theme code="review.write.title" arguments="${productData.name}" />
		</h3>
		<p>
		<div class="item_container writeReview">
			<div class="ui-grid-a reviewDetails">
				<div class="ui-block-a">
					<a href="${productDataUrl}" data-transition="slide"> <product:productCartImage product="${productData}" format="thumbnail" /> </a>
				</div>
			...
			<ul class="mFormList" data-inset="true" data-theme="d">
				...
				<c:url value="${productData.url}/writeReview" var="reviewFormAction" />
