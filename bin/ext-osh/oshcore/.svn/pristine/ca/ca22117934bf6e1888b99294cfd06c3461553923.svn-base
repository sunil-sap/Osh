...
/**
 * This class is created to add the BCC field in the order confirmation email
 */
public abstract class GenerateOrderConfirmationEmailAction extends AbstractSimpleDecisionAction
{
	private static final Logger LOG = Logger.getLogger(GenerateOrderConfirmationEmailAction.class);
			...
			final AbstractEmailContext emailContext, final BusinessProcessModel businessProcessModel)
	{
		...
		final String[] bccEmailIds = oshCommerceCheckoutService.collectBCCAddressForEmail();
