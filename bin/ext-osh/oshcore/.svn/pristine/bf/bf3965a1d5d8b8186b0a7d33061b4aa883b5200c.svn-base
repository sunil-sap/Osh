...
/**
 * Value provider for the WhiteGlove flag of product
 * 
 */
public class OshProductWhiteGloveValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider,
		Serializable
{
			...
			final IndexedProperty indexedProperty)
	{
		...
		//final boolean isWhiteGlove = ((OshVariantProductModel) product).getBaseProduct().isWhiteGlove();
		//if (isWhiteGlove)
		//{
		addFieldValues(fieldValues, indexedProperty, language, Boolean.valueOf(product.isWhiteGlove()));
		//}
		return fieldValues;
	}
