...
public class Base64
{
	 ...
	 * new to v2.3!</b> In earlier versions, it just returned a null value, but in retrospect that's a pretty poor way to
	 * handle it.
	 * </p>
	 * 
	 * 
	 ...
	 * @since 2.3.1
	 */
	public static byte[] encodeBytesToBytes(final byte[] source, final int off, final int len, final int options)
			throws java.io.IOException
	{
	 ...
	 * @since 2.3.4
	 */
	public static Object decodeToObject(final String encodedObject, final int options, final ClassLoader loader)
			throws java.io.IOException, java.lang.ClassNotFoundException
	{
		...
		try
		{
			...
			else
			{
				...
				{
					@Override
					public Class<?> resolveClass(final java.io.ObjectStreamClass streamClass) throws java.io.IOException,
