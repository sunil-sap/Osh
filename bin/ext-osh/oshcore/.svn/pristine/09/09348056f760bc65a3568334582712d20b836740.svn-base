...
public class NewCustomerCheckoutFlowStrategyTest
{
	...
	private CheckoutFlowStrategy initStrategy()
	{
		...
		final FixedCheckoutFlowStrategy singleStepStrategy = new FixedCheckoutFlowStrategy();
		singleStepStrategy.setCheckoutFlow(CheckoutFlowEnum.SINGLE);
		...
		strategy.setDefaultStrategy(singleStepStrategy);
