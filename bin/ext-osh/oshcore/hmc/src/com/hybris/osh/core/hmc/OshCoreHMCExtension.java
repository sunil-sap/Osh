 ...
 *  
 */
package com.hybris.osh.core.hmc;
...
/**
 * Provides necessary meta information about the oshcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class OshCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(OshCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.hybris.osh.core.hmc.locales";
