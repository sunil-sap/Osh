...
import com.hybris.osh.core.service.SFTPProductCheckService;
 ...
 * 
 */
public class DefaultSFTPProductCheckService implements SFTPProductCheckService
{
	...
	private static final String SFTP_COPY_FOLDER = "pom.product.file.sftp.from.folder";
	...
	@Override
	public boolean isProductFilesPresent()
	{
		...
		return oshSFTPService.checkProductFile(sftpHost, sftpUser, null, privateKey, productLocalFolder);
	}
