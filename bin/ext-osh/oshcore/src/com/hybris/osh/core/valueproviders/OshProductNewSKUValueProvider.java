...
/**
 * Value provider for the NewSku flag of product
 * 
 */
public class OshProductNewSKUValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
			...
			final IndexedProperty indexedProperty)
	{
		...
		//final boolean isNewSKU = ((OshVariantProductModel) product).getBaseProduct().isNewSKU();
		//if (isNewSKU)
		//{
		addFieldValues(fieldValues, indexedProperty, language, Boolean.valueOf(product.isNewSKU()));
		//}
		return fieldValues;
	}
