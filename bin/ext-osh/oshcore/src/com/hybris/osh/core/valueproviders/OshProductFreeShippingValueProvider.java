...
/**
 * Value provider for the free shipping flag of product
 * 
 */
public class OshProductFreeShippingValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider,
		Serializable
{
			...
			final IndexedProperty indexedProperty)
	{
		...
		//final boolean freeShipping = ((OshVariantProductModel) product).getBaseProduct().isFreeShipping();
		//if (freeShipping)
		//{
		addFieldValues(fieldValues, indexedProperty, language, Boolean.valueOf(product.isFreeShipping()));
		//	}
		return fieldValues;
	}
