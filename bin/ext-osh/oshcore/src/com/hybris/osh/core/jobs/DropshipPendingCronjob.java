...
/**
 * Job to send the drop ship request file.
 * 
 */
public class DropshipPendingCronjob extends AbstractJobPerformable<CronJobModel>
{
	...
	public PerformResult perform(final CronJobModel arg0)
	{
		...
		getDropshipFileCreatorService().createDropshipInputFile(triggerDate);
