...
public class OshProductMapPriceValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider,
		Serializable
{
			...
			final IndexedProperty indexedProperty)
	{
		...
		for (final PriceRow priceRow : priceRows)
		{
			...
			{
				if (customerPriceGroup.equalsIgnoreCase(OshCoreConstants.MAP_PRICE) && calculatePrice(priceRow))
				{
