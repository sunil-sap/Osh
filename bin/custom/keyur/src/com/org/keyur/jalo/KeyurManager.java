...
import com.org.keyur.constants.KeyurConstants;



/**
 * This is the extension manager of the Keyur extension.
 */
public class KeyurManager extends GeneratedKeyurManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(KeyurManager.class.getName());
	 ...
	 */
	public static KeyurManager getInstance()
	{
		return (KeyurManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				KeyurConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public KeyurManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of KeyurManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of KeyurManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of KeyurManager called, current tenant: " + getTenant().getTenantID());
		}
	}
